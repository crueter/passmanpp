    ...
    for (Field *field : entry->fields()) {
        ...
        switch (field->type()) {
            case QMetaType::QString: {
                ...
                displayErr(tr("Something has gone horribly wrong. Field type (") + QString(static_cast<QChar>(field->type())) + QString::fromStdString(") is invalid, where valid values are: 2, 6, 10, and 12. Report this issue immediately to" + github));
                break;
            }
        }
    }
