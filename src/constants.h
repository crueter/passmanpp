...
static std::vector<const char*> encryptionMatch = {"AES-256/GCM", "Twofish"};

static std::string PASSMAN_VERSION = "2.0.0 DEBUG";
static std::string BOTAN_VERSION = std::to_string(BOTAN_VERSION_MAJOR) + "." + std::to_string(BOTAN_VERSION_MINOR) + "-" + std::to_string(BOTAN_VERSION_PATCH);

static std::string tips = "A good password contains:\n"
...
static std::string info = "passman++ is a simple, minimal, yet powerful, secure command-line password manager. Written in C++, passman++ is a complete rewrite of my original passman project (https://github.com/binex-dsk/PyPassMan) intended to be far more secure, feature-rich, fast, and most of all, to help me learn C++.\n"
